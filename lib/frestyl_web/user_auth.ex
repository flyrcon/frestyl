defmodule FrestylWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule FrestylWeb.PageLive do
        use FrestylWeb, :live_view

        on_mount {FrestylWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FrestylWeb.UserAuth, :ensure_authenticated}] do
