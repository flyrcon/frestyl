defmodule FrestylWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :frestyl
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :frestyl
  end
